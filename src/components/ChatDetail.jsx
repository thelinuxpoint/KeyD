...
function ChatDetail() {
    ...
    return (
        ...
        <div className="flex flex-col h-screen">
            {/* Contact nav */}
            <div className="flex justify-between bg-[#282d3f] h-[60px] p-3">
                {/* Contact info */}
            ...
            {/* Messages section */}
            <div
                className="bg-[#0a131a] bg-[url('assets/images/poly.svg')] bg-cover bg-no-repeat overflow-y-scroll h-100"
            ...
            {/* Bottom section */}
            <div className="flex items-center bg-[#282d3f] w-100 h-[70px] p-2">
                {/* Emoji btn */}
                ...
                <input
                    ...
                    className="bg-[#161923] rounded-lg outline-none text-sm text-neutral-200 w-100 h-100 px-3 placeholder:text-sm placeholder:text-[#8796a1]"
